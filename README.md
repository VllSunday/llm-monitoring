...
- API-сервис на FastAPI с дашбордом в тёмной теме: вёрстка по токенам shadcn/ui, без внешних JS-библиотек.
...
Шесть вкладок: обзор, playground и по одной на каждый кейс. Оформление собрано на токенах shadcn/ui (тема zinc, палитра chart-1..chart-5), графики нарисованы на чистом SVG. Ни одного CDN, дашборд работает без интернета.
